...
class Output:
    ...
    def _output_loop(
        ...
        while not stop_event.is_set():
            try:
                ...
                added_timestamp = transcription.added_timestamp.strftime(
                    "%Y-%m-%d %H:%M:%S"
                )
                ...
                highlighted_text = self._highlight_text(
                    text, shared_colors, shared_colors_lock
                )
    ...
    def _highlight_text(
        self, text: str, shared_colors: dict, shared_colors_lock
    ) -> str:
            ...
            for phrase in phrases:
                ...
                positions = [
                    ...
                    for pos in re.finditer(
                        re.escape(phrase.lower()), search_text, re.IGNORECASE
                    )
                ]
                ...
                for start, end in reversed(positions):
                    ...
                    highlighted_text = insert_string(
                        highlighted_text, opening_tag, start
                    )
